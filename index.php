...
<html lang="pt-BR">
  <head>
    <title>Expansão Cultural &mdash; Website by Expansão Tech</title>
    <meta charset="utf-8">
          ...
          <div class="ml-auto w-25">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="#contact-section" class="nav-link"><span>Fale Conosco</span></a></li>
              </ul>
            </nav>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-4">
                  <h1 data-aos="fade-up" data-aos-delay="100">Aprenda com Especialistas</h1>
                  <p class="mb-4" data-aos="fade-up" data-aos-delay="200">Acesse sua conta ou cadastre-se gratuitamente para ver nossos conteúdos exclusivos.</p>
        ...
        <div class="row">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <ul class="list-unstyled footer-links">
              ...
              <li><a href="#programs-section">Programas</a></li>
              <li><a href="#teachers-section">Professores</a></li>
            </ul>
          </div>
          ...
          <div class="col-md-4">
            ...
            <form action="#" class="footer-subscribe">
              <div class="d-flex mb-5">
                ...
                <input type="submit" class="btn btn-primary rounded-0" value="Assinar">
              </div>
            </form>
          </div>
